...
var Subscriber = require('./subscriber.js').Subscriber;

/**
 * Creates a new PubHub for a given feed and subscribers.
 *
 * @param {Subscriber} subscriber
 *   A subscriber object with a feed and list of subscribers.
 * @constructor
 */
function PubHub(subscriber) {
  ...
  self.feed = url.parse(subscriber.Subscriber.feed);
  self.subscribers = subscriber.Subscriber.subscribers;
  ...
  subscriber.on('saved', function onSaved(message) {
    // Update our info.
    self.feed = subscriber.Subscriber.feed;
    self.subscribers = subscriber.Subscriber.subscribers;
